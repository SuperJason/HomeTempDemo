...
// https://blog.csdn.net/baidu_24743861/article/details/115869652
...
// TODO Auto-generated method stub
    ...
    public void Lunar(Calendar cal) {
...
//offset小于0时，也要校正
    ...
    public static String getLunar(int year, int month, int day) {
        //转农历
        java.text.SimpleDateFormat abc = new java.text.SimpleDateFormat("yyyy年MM月dd日");
        String nowday = year + "年" + month + "月" + day + "日";
